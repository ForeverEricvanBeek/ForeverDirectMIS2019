...
string DatamartProjectName = @"SSIS_ForeverData02";
string projectWorkDir = @"\\FDODWHD01\StagingFiles";
string CacheDir = projectWorkDir + @"\BimlBI\SSIS Cache";
string ImportDir = projectWorkDir + @"\BimlBI";
string ExportDir = projectWorkDir + @"\BimlBI\Output";
string ArchiveDir = projectWorkDir + @"\BimlBI\Archive";
string ErrorDir = projectWorkDir + @"\BimlBI\Error";
...
string conGeneratorConnectionString = @"Data Source=" + projectServerNameAndDatabaseInstanceName + @";Initial Catalog=DWH_Control;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;";
