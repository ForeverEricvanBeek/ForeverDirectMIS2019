...
string stagingProjectName = @"SSIS_IFS_TEMP";
string DWHProjectName = @"SSIS_IFS_TEMP";
...
string projectDatabaseInstanceName = @"DWHIFS"; // Only the instance name, don't include the server name.
string SystemConnection = "DWI_Control";
string StagingConnection = "StagingIFS_TEMP";
