CREATE TABLE [DM].[D_Country] (
    ...
    [FD_Region_Code]      NVARCHAR (13) NOT NULL,
    [FD_Home_Country]     NVARCHAR (7)  NULL,
    [FD_OP_Country]       NVARCHAR (6)  NULL,
    [FD_CIM_Country_A3]   NVARCHAR (6)  NULL,
    [FD_CIM_Full_Country] NVARCHAR (40) NULL,
    [FD_Country_Group]    NVARCHAR (40) NULL,
