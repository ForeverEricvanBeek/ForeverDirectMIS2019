CREATE TABLE [DM].[D_BOM_Explosie] (
    ...
    [Component_Part_Description] NVARCHAR (200) NULL,
    [Bonus_Part]                 NVARCHAR (5)   NULL,
    [Component_Product_Family]   NVARCHAR (5)   NULL,
    [Sales_Part_Product_Family]  NVARCHAR (5)   NULL,
    [FAM_Component_Niveau]       NVARCHAR (35)  NULL,
    [FAM_Sales_Part_Niveau]      NVARCHAR (35)  NULL,
