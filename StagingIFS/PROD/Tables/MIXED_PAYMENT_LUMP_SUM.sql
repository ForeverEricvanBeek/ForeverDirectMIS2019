CREATE TABLE [PROD].[MIXED_PAYMENT_LUMP_SUM] (
    ...
    CONSTRAINT [PK_MIXED_PAYMENT_LUMP_SUM] PRIMARY KEY CLUSTERED ([COMPANY] ASC, [MIXED_PAYMENT_ID] ASC, [LUMP_SUM_TRANS_ID] ASC)
);
