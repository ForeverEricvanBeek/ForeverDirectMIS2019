CREATE TABLE [PROJWMS].[SHOP_MATERIAL_ALLOC] (
    ...
    CONSTRAINT [PK_SHOP_MATERIAL_ALLOC_1] PRIMARY KEY CLUSTERED ([ORDER_NO] ASC, [RELEASE_NO] ASC, [SEQUENCE_NO] ASC, [LINE_ITEM_NO] ASC)
);
