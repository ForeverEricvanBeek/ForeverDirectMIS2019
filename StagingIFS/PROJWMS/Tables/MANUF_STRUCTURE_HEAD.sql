CREATE TABLE [PROJWMS].[MANUF_STRUCTURE_HEAD] (
    ...
    CONSTRAINT [PK_MANUF_STRUCTURE_HEAD_1] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [PART_NO] ASC, [ENG_CHG_LEVEL] ASC, [BOM_TYPE_DB] ASC)
);
