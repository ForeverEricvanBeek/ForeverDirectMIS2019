CREATE TABLE [PROJWMS].[SHOP_ORDER_OPERATION] (
    ...
    CONSTRAINT [PK_SHOP_ORDER_OPERATION_1] PRIMARY KEY CLUSTERED ([ORDER_NO] ASC, [RELEASE_NO] ASC, [SEQUENCE_NO] ASC, [OPERATION_NO] ASC)
);
