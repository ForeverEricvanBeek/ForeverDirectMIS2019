...
Select 
  ...
  , IM.CASE_SIZE_TYPE
  , O.DSG_SHIP_VIA
  , CONVERT(NVARCHAR(8),AD.MOD_DATE_TIME,112) AS MOD_DATE_TIME
...
AND				AD.ActInd = 'Y'
--AND				AD.MOD_DATE_TIME >= '20190101'
--AND				AD.MOD_DATE_TIME < '20190327'
AND AD.QTY_ALLOC <> 0
GROUP BY
  PZ.GRP_ATTR
  , LH.DSP_LOCN
  ...
  , IM.CASE_SIZE_TYPE
	, O.DSG_SHIP_VIA
	, CONVERT(NVARCHAR(8),AD.MOD_DATE_TIME,112)
