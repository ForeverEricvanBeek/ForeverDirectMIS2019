...
SELECT DISTINCT 
		...
		, CAST(FD.STATUS_DATE_SH AS DATETIME2(7))					AS OLPN_Ship_Confirm_Date
		, CAST(FD.STATUS_DATE_IN AS DATETIME2(7))					AS OLPN_First_Scan_Date
		, CAST(ISNULL(FD.STATUS_DATE_AT,FD.STATUS_DATE_DL) AS DATETIME2(7)) AS OLPN_First_Attempt_Date
		, CAST(FD.STATUS_DATE_DL AS DATETIME2(7))					AS OLPN_Delivered_Date
		...
		, CAST('//FDXDOCP01/PackingslipPRD/'  + REPLACE(PP.fileName,'\','/') AS NVARCHAR(4000)) AS OLPN_Document_Location
