CREATE TABLE [KEWILL].[partyn] (
    ...
    CONSTRAINT [PK_partyn] PRIMARY KEY CLUSTERED ([vrfilk] ASC, [rnropd] ASC, [artkd] ASC, [vrvrdt] ASC, [ptykd] ASC, [ptdati] ASC, [vrvolg] ASC, [Eff_Date] ASC) WITH (FILLFACTOR = 90) ON [DWH_KEWILL]
) ON [DWH_KEWILL];
