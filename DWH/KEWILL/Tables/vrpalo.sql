CREATE TABLE [KEWILL].[vrpalo] (
    ...
    CONSTRAINT [PK_vrpalo] PRIMARY KEY NONCLUSTERED ([vrfilk] ASC, [rnropd] ASC, [artkd] ASC, [magkd] ASC, [lockd] ASC, [vrvrdt] ASC, [ptykd] ASC, [ptdati] ASC, [vrvolg] ASC, [Eff_Date] ASC)
);
