...
CREATE VIEW [FDV].[VW_F_Bom]
AS

WITH CTE_1 AS (
	SELECT
		--CONCAT(MH.CONTRACT,CB.ITEM_ID)	AS PART_CODE
		MH.PART_NO						AS PART_CODE
...
, CTE_2 AS (
	SELECT
		...
		ISNULL(MS1.PART_NO,'-1')								AS Sales_SKU_Code
		,ISNULL(MS1.COMPONENT_PART,'-1')						AS Component_L1_SKU_Code
		,ISNULL(MS2.COMPONENT_PART,'-1')						AS Component_L2_SKU_Code
		,ISNULL(MS3.COMPONENT_PART,'-1')						AS Component_L3_SKU_Code
	...
	GROUP BY
		...
		ISNULL(MS1.PART_NO,'-1')		
		,ISNULL(MS1.COMPONENT_PART,'-1')	
		,ISNULL(MS2.COMPONENT_PART,'-1')	
		,ISNULL(MS3.COMPONENT_PART,'-1')
