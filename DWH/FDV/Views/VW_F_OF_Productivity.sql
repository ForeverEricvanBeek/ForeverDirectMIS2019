...
AND		     PT.CREATE_DATE_TIME > '20180101'
UNION ALL
...
AND			PI.ActInd = 'Y'
WHERE RP.ActInd = 'Y'
AND         CONVERT(CHAR, CAST(CAST(SUBSTRING(RP.TimeIn,1,4) AS NVARCHAR(4))+N'-'+CAST(SUBSTRING(RP.TimeIn,5,2) AS NVARCHAR(2))+N'-'+CAST(SUBSTRING(RP.TimeIn,7,2) AS NVARCHAR(2)) AS DATE), 112)> '20180101'
