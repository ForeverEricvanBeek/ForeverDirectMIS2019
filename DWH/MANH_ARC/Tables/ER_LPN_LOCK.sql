CREATE TABLE [MANH_ARC].[ER_LPN_LOCK] (
    ...
    CONSTRAINT [PK_ER_LPN_LOCK] PRIMARY KEY CLUSTERED ([ACTION] ASC, [LPN_ID] ASC, [LPN_LOCK_ID] ASC, [TRANSACTION_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
