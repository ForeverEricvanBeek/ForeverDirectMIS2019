CREATE TABLE [MANH_ARC].[PICK_LOCN_DTL] (
    ...
    CONSTRAINT [PK_MANH_PICK_LOCN_DTL] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [PICK_LOCN_DTL_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
