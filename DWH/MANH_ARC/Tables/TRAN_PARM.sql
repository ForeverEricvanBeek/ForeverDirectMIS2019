CREATE TABLE [MANH_ARC].[TRAN_PARM] (
    ...
    CONSTRAINT [PK_MANH_TRAN_PARM] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [TRAN_PARM_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
