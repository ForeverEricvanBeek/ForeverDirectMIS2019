CREATE TABLE [MANH_ARC].[FACILITY_CONTACT] (
    ...
    CONSTRAINT [PK_FACILITY_CONTACT] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [FACILITY_CONTACT_ID] ASC, [FACILITY_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
