CREATE TABLE [MANH_ARC].[WAVE_PARM] (
    ...
    CONSTRAINT [PK_MANH_WAVE_PARM] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [WAVE_PARM_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
