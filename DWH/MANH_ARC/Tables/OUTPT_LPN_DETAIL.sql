CREATE TABLE [MANH_ARC].[OUTPT_LPN_DETAIL] (
    ...
    CONSTRAINT [PK_MANH_OUTPT_LPN_DETAIL] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [OUTPT_LPN_DETAIL_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
