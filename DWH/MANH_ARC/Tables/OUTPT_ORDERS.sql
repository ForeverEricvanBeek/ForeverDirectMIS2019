CREATE TABLE [MANH_ARC].[OUTPT_ORDERS] (
    ...
    CONSTRAINT [PK_MANH_OUTPT_ORDERS] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [OUTPT_ORDERS_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
