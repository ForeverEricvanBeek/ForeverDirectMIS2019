CREATE TABLE [MANH_ARC].[LPN_OUTBOUND] (
    ...
    CONSTRAINT [PK_MANH_LPN_OUTBOUND] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LPN_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
