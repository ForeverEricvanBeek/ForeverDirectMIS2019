CREATE TABLE [MANH_ARC].[ASN_POC_DETAIL] (
    ...
    CONSTRAINT [PK_MANH_ASN_POC_DETAIL] PRIMARY KEY CLUSTERED ([ASN_ID] ASC, [ASN_POC_DETAIL_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
