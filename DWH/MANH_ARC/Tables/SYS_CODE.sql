CREATE TABLE [MANH_ARC].[SYS_CODE] (
    ...
    CONSTRAINT [PK_MANH_SYS_CODE] PRIMARY KEY CLUSTERED ([CODE_ID] ASC, [CODE_TYPE] ASC, [Eff_Date] ASC, [REC_TYPE] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
