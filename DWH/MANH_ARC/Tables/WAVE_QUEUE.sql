CREATE TABLE [MANH_ARC].[WAVE_QUEUE] (
    ...
    CONSTRAINT [PK_MANH_WAVE_QUEUE] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [WAVE_QUEUE_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
