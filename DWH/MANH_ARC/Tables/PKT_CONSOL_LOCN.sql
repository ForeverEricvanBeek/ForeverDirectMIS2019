CREATE TABLE [MANH_ARC].[PKT_CONSOL_LOCN] (
    ...
    CONSTRAINT [PK_MANH_PKT_CONSOL_LOCN] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [PKT_CONSOL_LOCN_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
