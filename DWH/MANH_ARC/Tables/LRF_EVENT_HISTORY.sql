CREATE TABLE [MANH_ARC].[LRF_EVENT_HISTORY] (
    ...
    CONSTRAINT [PK_MANH_LRF_EVENT_HISTORY] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LRF_EVENT_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
