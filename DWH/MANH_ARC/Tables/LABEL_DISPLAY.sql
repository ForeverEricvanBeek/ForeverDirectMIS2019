CREATE TABLE [MANH_ARC].[LABEL_DISPLAY] (
    ...
    CONSTRAINT [PK_MANH_LABEL_DISPLAY] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LABEL_DISPLAY_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
