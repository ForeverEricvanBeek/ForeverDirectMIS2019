CREATE TABLE [MANH_ARC].[SHIPMENT_COMMODITY] (
    ...
    CONSTRAINT [PK_MANH_SHIPMENT_COMMODITY] PRIMARY KEY CLUSTERED ([COMMODITY_CLASS] ASC, [Eff_Date] ASC, [SHIPMENT_ID] ASC, [SIZE_UOM_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
