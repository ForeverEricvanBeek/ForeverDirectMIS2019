CREATE TABLE [MANH_ARC].[SHIPMENT] (
    ...
    CONSTRAINT [PK_MANH_SHIPMENT] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [SHIPMENT_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
