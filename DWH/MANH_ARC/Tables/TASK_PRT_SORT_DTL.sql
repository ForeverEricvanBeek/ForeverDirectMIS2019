CREATE TABLE [MANH_ARC].[TASK_PRT_SORT_DTL] (
    ...
    CONSTRAINT [PK_MANH_TASK_PRT_SORT_DTL] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [TASK_PRT_SORT_DTL_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
