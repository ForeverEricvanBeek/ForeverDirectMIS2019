CREATE TABLE [MANH_ARC].[PURCHASE_ORDERS_LINE_ITEM] (
    ...
    CONSTRAINT [PK_MANH_PURCHASE_ORDERS_LINE_ITEM] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [PURCHASE_ORDERS_ID] ASC, [PURCHASE_ORDERS_LINE_ITEM_ID] ASC) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
