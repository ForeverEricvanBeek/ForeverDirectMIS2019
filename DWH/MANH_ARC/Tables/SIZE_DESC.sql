CREATE TABLE [MANH_ARC].[SIZE_DESC] (
    ...
    CONSTRAINT [PK_MANH_SIZE_DESC] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [SIZE_DESC_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
