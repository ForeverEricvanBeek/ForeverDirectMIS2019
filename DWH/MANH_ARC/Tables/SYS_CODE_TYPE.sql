CREATE TABLE [MANH_ARC].[SYS_CODE_TYPE] (
    ...
    CONSTRAINT [PK_MANH_SYS_CODE_TYPE] PRIMARY KEY CLUSTERED ([CODE_TYPE] ASC, [Eff_Date] ASC, [REC_TYPE] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
