CREATE TABLE [MANH_ARC].[ORDER_NOTE] (
    ...
    CONSTRAINT [PK_MANH_ORDER_NOTE] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LINE_ITEM_ID] ASC, [NOTE_SEQ] ASC, [ORDER_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
