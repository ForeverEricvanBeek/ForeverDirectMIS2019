CREATE TABLE [MANH_ARC].[UN_NUMBER] (
    ...
    CONSTRAINT [PK_MANH_UN_NUMBER] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [UN_NUMBER_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
