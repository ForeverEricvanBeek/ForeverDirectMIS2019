CREATE TABLE [MANH_ARC].[PHYS_INVN_HDR] (
    ...
    CONSTRAINT [PK_MANH_PHYS_INVN_HDR] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [PHYS_INVN_HDR_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH_ARC]
) ON [DWH_MANH_ARC];
