CREATE TABLE [FORECAST].[Realize_Sales] (
    ...
    CONSTRAINT [PK_Realize_Sales] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [OFFICE_CODE] ASC, [PROCESSMONTH] ASC, [PROCESSYEAR] ASC, [PRODUCTNUM] ASC, [Quantity] ASC) ON [DWH_FORECAST]
) ON [DWH_FORECAST];
