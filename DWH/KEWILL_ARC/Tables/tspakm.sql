CREATE TABLE [KEWILL_ARC].[tspakm] (
    ...
    CONSTRAINT [PK_tspakm] PRIMARY KEY CLUSTERED ([vrfilk] ASC, [vrvolg] ASC, [vrvrdt] ASC, [artkd] ASC, [Eff_Date] ASC, [ptdati] ASC, [ptykd] ASC, [rnropd] ASC, [tskenm] ASC) ON [DWH_KEWILL_ARC]
) ON [DWH_KEWILL_ARC];
