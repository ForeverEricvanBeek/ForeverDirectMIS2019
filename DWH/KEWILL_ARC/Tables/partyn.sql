CREATE TABLE [KEWILL_ARC].[partyn] (
    ...
    CONSTRAINT [PK_partyn] PRIMARY KEY CLUSTERED ([artkd] ASC, [Eff_Date] ASC, [ptdati] ASC, [ptykd] ASC, [rnropd] ASC, [vrfilk] ASC, [vrvolg] ASC, [vrvrdt] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_KEWILL_ARC]
) ON [DWH_KEWILL_ARC];
