CREATE TABLE [KEWILL_ARC].[tsloth] (
    [vrfilk]       INT             NOT NULL,
    ...
    CONSTRAINT [PK_tsloth] PRIMARY KEY CLUSTERED ([artkd] ASC, [Eff_Date] ASC, [ptdati] ASC, [ptykd] ASC, [rnropd] ASC, [vrfilk] ASC, [vrvolg] ASC, [vrvrdt] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_KEWILL_ARC]
) ON [DWH_KEWILL_ARC];
