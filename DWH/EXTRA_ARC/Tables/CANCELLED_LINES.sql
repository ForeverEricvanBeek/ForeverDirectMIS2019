CREATE TABLE [EXTRA_ARC].[CANCELLED_LINES] (
    ...
    CONSTRAINT [PK_CANCELLED_LINES_1] PRIMARY KEY CLUSTERED ([TC_order_ID] ASC, [Issue] ASC, [SKU_Code] ASC, [Eff_Date] ASC) ON [DWH_EXTRA_ARC]
) ON [DWH_EXTRA_ARC];
