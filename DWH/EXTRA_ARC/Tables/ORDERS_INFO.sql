CREATE TABLE [EXTRA_ARC].[ORDERS_INFO] (
    ...
    CONSTRAINT [PK_ORDERS_INFO] PRIMARY KEY CLUSTERED ([TC_Order_ID] ASC, [Eff_Date] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_EXTRA_ARC]
) ON [DWH_EXTRA_ARC];
