CREATE TABLE [TRANS].[SHIPMENT_CONSOLIDATED] (
    ...
    CONSTRAINT [PK_SHIPMENT_CONSOLIDATED] PRIMARY KEY CLUSTERED ([SHIPMENT_ID] ASC, [Eff_Date] ASC) WITH (FILLFACTOR = 90) ON [DWH_TRANS]
) ON [DWH_TRANS];
