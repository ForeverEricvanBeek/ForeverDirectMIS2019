CREATE TABLE [IFS_ARC].[PAYMENT_TRANSACTION] (
    ...
    CONSTRAINT [PK_PAYMENT_TRANSACTION] PRIMARY KEY CLUSTERED ([COMPANY] ASC, [SERIES_ID] ASC, [PAYMENT_ID] ASC, [TRANS_ID] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
