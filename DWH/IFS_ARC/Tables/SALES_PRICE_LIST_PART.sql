CREATE TABLE [IFS_ARC].[SALES_PRICE_LIST_PART] (
    ...
    CONSTRAINT [PK_SALES_PRICE_LIST_PART] PRIMARY KEY CLUSTERED ([CATALOG_NO] ASC, [Eff_Date] ASC, [MIN_QUANTITY] ASC, [PRICE_LIST_NO] ASC, [VALID_FROM_DATE] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
