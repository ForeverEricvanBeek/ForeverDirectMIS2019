CREATE TABLE [IFS_ARC].[SUPPLIER_INFO_ADDRESS_TYPE] (
    ...
    CONSTRAINT [PK_SUPPLIER_INFO_ADDRESS_TYPE] PRIMARY KEY CLUSTERED ([ADDRESS_ID] ASC, [ADDRESS_TYPE_CODE_DB] ASC, [Eff_Date] ASC, [SUPPLIER_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
