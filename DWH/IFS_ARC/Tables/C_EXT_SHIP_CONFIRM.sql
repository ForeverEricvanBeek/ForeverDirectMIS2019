CREATE TABLE [IFS_ARC].[C_EXT_SHIP_CONFIRM] (
    ...
    CONSTRAINT [PK_C_EXT_SHIP_CONFIRM] PRIMARY KEY CLUSTERED ([APPLICATION_MESSAGE_ID] ASC, [Eff_Date] ASC, [SHIPMENT_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
