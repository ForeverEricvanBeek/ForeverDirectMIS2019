CREATE TABLE [IFS_ARC].[SUPPLIER_INFO_ADDRESS] (
    ...
    CONSTRAINT [PK_SUPPLIER_INFO_ADDRESS] PRIMARY KEY CLUSTERED ([SUPPLIER_ID] ASC, [ADDRESS_ID] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
