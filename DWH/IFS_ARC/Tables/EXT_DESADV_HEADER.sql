CREATE TABLE [IFS_ARC].[EXT_DESADV_HEADER] (
    ...
    CONSTRAINT [PK_EXT_DESADV_HEADER] PRIMARY KEY CLUSTERED ([MESSAGE_ID] ASC, [DELNOTE_NO] ASC, [Eff_Date] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
