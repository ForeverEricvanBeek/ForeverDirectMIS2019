CREATE TABLE [IFS_ARC].[C_KFD_CMSCOUNTER_HIST] (
    ...
    CONSTRAINT [PK_C_KFD_CMSCOUNTER_HIST] PRIMARY KEY CLUSTERED ([TRANSACTION_ID] ASC, [CONTRACT] ASC, [PART_NO] ASC, [LOT_BATCH_NO] ASC, [PKG_UNIT_ID] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
