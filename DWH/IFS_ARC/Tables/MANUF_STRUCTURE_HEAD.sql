CREATE TABLE [IFS_ARC].[MANUF_STRUCTURE_HEAD] (
    ...
    CONSTRAINT [PK_MANUF_STRUCTURE_HEAD] PRIMARY KEY CLUSTERED ([BOM_TYPE_DB] ASC, [CONTRACT] ASC, [Eff_Date] ASC, [ENG_CHG_LEVEL] ASC, [PART_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
