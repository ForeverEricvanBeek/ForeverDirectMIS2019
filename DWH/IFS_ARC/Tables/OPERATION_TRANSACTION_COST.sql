CREATE TABLE [IFS_ARC].[OPERATION_TRANSACTION_COST] (
    ...
    CONSTRAINT [PK_OPERATION_TRANSACTION_COST] PRIMARY KEY CLUSTERED ([TRANSACTION_ID] ASC, [COMPANY] ASC, [COST_SOURCE_ID] ASC, [CONTRACT] ASC, [PART_NO] ASC, [COST_BUCKET_ID] ASC, [ACCOUNTING_YEAR] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
