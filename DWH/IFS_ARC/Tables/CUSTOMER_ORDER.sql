CREATE TABLE [IFS_ARC].[CUSTOMER_ORDER] (
    ...
    CONSTRAINT [PK_CUSTOMER_ORDER] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [ORDER_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
