CREATE TABLE [IFS_ARC].[INTRASTAT_LINE] (
    ...
    CONSTRAINT [PK_INTRASTAT_LINE] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [INTRASTAT_ID] ASC, [LINE_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
