CREATE TABLE [IFS_ARC].[INVENTORY_TRANSACTION_COST] (
    ...
    CONSTRAINT [PK_INVENTORY_TRANSACTION_COST] PRIMARY KEY CLUSTERED ([TRANSACTION_ID] ASC, [CONTRACT] ASC, [COST_BUCKET_ID] ASC, [COMPANY] ASC, [COST_SOURCE_ID] ASC, [ACCOUNTING_YEAR] ASC, [ADDED_TO_THIS_TRANSACTION_DB] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
