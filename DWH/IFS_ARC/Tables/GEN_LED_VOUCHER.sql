CREATE TABLE [IFS_ARC].[GEN_LED_VOUCHER] (
    ...
    CONSTRAINT [PK_GEN_LED_VOUCHER] PRIMARY KEY CLUSTERED ([ACCOUNTING_YEAR] ASC, [COMPANY] ASC, [Eff_Date] ASC, [VOUCHER_NO] ASC, [VOUCHER_TYPE] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
