CREATE TABLE [IFS_ARC].[ROUTING_OPERATION] (
    ...
    CONSTRAINT [PK_ROUTING_OPERATION] PRIMARY KEY CLUSTERED ([ALTERNATIVE_NO] ASC, [BOM_TYPE_DB] ASC, [CONTRACT] ASC, [Eff_Date] ASC, [OPERATION_ID] ASC, [PART_NO] ASC, [ROUTING_REVISION] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
