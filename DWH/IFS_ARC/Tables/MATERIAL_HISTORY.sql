CREATE TABLE [IFS_ARC].[MATERIAL_HISTORY] (
    ...
    CONSTRAINT [PK_MATERIAL_HISTORY] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [MATERIAL_HISTORY_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
