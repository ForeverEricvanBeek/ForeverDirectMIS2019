CREATE TABLE [IFS_ARC].[SHIPMENT_ORDER_LINE] (
    ...
    CONSTRAINT [PK_SHIPMENT_ORDER_LINE] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LINE_ITEM_NO] ASC, [LINE_NO] ASC, [ORDER_NO] ASC, [REL_NO] ASC, [SHIPMENT_ID] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
