CREATE TABLE [IFS_ARC].[SALES_PART_CROSS_REFERENCE] (
    ...
    CONSTRAINT [PK_SALES_PART_CROSS_REFERENCE] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [CUSTOMER_NO] ASC, [CUSTOMER_PART_NO] ASC, [Eff_Date] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
