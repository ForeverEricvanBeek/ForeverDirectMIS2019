CREATE TABLE [IFS_ARC].[SALES_PART_CROSS_REFERENCE] (
    ...
    CONSTRAINT [PK_SALES_PART_CROSS_REFERENCE] PRIMARY KEY CLUSTERED ([CUSTOMER_PART_NO] ASC, [CONTRACT] ASC, [CUSTOMER_NO] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
