CREATE TABLE [IFS_ARC].[CUSTOMER_ORDER_LINE] (
    ...
    CONSTRAINT [PK_CUSTOMER_ORDER_LINE] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LINE_ITEM_NO] ASC, [LINE_NO] ASC, [ORDER_NO] ASC, [REL_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
