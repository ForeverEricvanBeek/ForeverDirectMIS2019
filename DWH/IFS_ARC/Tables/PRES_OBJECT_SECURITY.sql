CREATE TABLE [IFS_ARC].[PRES_OBJECT_SECURITY] (
    ...
    CONSTRAINT [PK_PRES_OBJECT_SECURITY] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [PO_ID] ASC, [SEC_OBJECT] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
