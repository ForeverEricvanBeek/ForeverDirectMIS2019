CREATE TABLE [IFS_ARC].[CUST_PRICE_GROUP_DETAIL] (
    ...
    CONSTRAINT [PK_CUST_PRICE_GROUP_DETAIL] PRIMARY KEY CLUSTERED ([COMPANY] ASC, [CURRENCY_CODE] ASC, [CUST_PRICE_GROUP_ID] ASC, [Eff_Date] ASC, [SALES_PRICE_GROUP_ID] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
