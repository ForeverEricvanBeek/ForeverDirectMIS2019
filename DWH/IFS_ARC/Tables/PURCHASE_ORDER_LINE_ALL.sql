CREATE TABLE [IFS_ARC].[PURCHASE_ORDER_LINE_ALL] (
    ...
    CONSTRAINT [PK_PURCHASE_ORDER_LINE_ALL] PRIMARY KEY CLUSTERED ([ORDER_NO] ASC, [LINE_NO] ASC, [RELEASE_NO] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
