CREATE TABLE [IFS_ARC].[WORK_CENTER] (
    ...
    CONSTRAINT [PK_WORK_CENTER] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [WORK_CENTER_NO] ASC, [Eff_Date] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
