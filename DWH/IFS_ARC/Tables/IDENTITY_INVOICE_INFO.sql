CREATE TABLE [IFS_ARC].[IDENTITY_INVOICE_INFO] (
    ...
    CONSTRAINT [PK_IDENTITY_INVOICE_INFO] PRIMARY KEY CLUSTERED ([COMPANY] ASC, [Eff_Date] ASC, [IDENTITY] ASC, [PARTY_TYPE_DB] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
