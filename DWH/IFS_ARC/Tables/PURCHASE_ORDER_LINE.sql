CREATE TABLE [IFS_ARC].[PURCHASE_ORDER_LINE] (
    ...
    CONSTRAINT [PK_PURCHASE_ORDER_LINE] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LINE_NO] ASC, [ORDER_NO] ASC, [RELEASE_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
