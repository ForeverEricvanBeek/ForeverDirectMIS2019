CREATE TABLE [IFS_ARC].[PURCHASE_RECEIPT] (
    ...
    CONSTRAINT [PK_PURCHASE_RECEIPT] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LINE_NO] ASC, [ORDER_NO] ASC, [RECEIPT_NO] ASC, [RELEASE_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
