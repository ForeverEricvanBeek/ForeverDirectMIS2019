CREATE TABLE [IFS_ARC].[COMM_METHOD] (
    ...
    CONSTRAINT [PK_COMM_METHOD] PRIMARY KEY CLUSTERED ([PARTY_TYPE_DB] ASC, [IDENTITY] ASC, [COMM_ID] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
