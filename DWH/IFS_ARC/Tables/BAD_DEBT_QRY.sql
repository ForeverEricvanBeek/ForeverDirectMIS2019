CREATE TABLE [IFS_ARC].[BAD_DEBT_QRY] (
    ...
    CONSTRAINT [PK_BAD_DEBT_QRY] PRIMARY KEY CLUSTERED ([COMPANY] ASC, [PARTY_TYPE_DB] ASC, [SERIES_ID] ASC, [INVOICE_NO] ASC, [LEDGER_ITEM_VERSION] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
