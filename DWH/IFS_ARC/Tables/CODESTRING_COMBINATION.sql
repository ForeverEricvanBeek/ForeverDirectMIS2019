CREATE TABLE [IFS_ARC].[CODESTRING_COMBINATION] (
    ...
    CONSTRAINT [PK_CODESTRING_COMBINATION] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [POSTING_COMBINATION_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
