CREATE TABLE [IFS_ARC].[INVENTORY_PART_UNIT_COST_SUM] (
    ...
    CONSTRAINT [PK_INVENTORY_PART_UNIT_COST_SUM] PRIMARY KEY CLUSTERED ([CONFIGURATION_ID] ASC, [CONTRACT] ASC, [Eff_Date] ASC, [LOT_BATCH_NO] ASC, [PART_NO] ASC, [SERIAL_NO] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
