CREATE TABLE [IFS_ARC].[QUICK_REPORT] (
    ...
    CONSTRAINT [PK_QUICK_REPORT] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [QUICK_REPORT_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
