CREATE TABLE [IFS_ARC].[SHOP_MATERIAL_ALLOC] (
    ...
    CONSTRAINT [PK_SHOP_MATERIAL_ALLOC] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LINE_ITEM_NO] ASC, [ORDER_NO] ASC, [RELEASE_NO] ASC, [SEQUENCE_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
