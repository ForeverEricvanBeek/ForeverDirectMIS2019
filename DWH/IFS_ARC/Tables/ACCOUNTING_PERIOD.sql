CREATE TABLE [IFS_ARC].[ACCOUNTING_PERIOD] (
    ...
    CONSTRAINT [PK_ACCOUNTING_PERIOD] PRIMARY KEY CLUSTERED ([ACCOUNTING_PERIOD] ASC, [ACCOUNTING_YEAR] ASC, [COMPANY] ASC, [Eff_Date] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
