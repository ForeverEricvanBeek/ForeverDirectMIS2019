CREATE TABLE [IFS_ARC].[TECHNICAL_SPECIFICATION_BOTH] (
    ...
    CONSTRAINT [PK_TECHNICAL_SPECIFICATION_BOTH] PRIMARY KEY CLUSTERED ([ATTRIBUTE] ASC, [Eff_Date] ASC, [TECHNICAL_SPEC_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
