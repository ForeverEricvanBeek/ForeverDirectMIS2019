CREATE TABLE [IFS_ARC].[INVOICE_UTILITY_INV_HEAD_PUB] (
    ...
    CONSTRAINT [PK_INVOICE_UTILITY_INV_HEAD_PUB] PRIMARY KEY CLUSTERED ([INVOICE_ID] ASC, [COMPANY] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
