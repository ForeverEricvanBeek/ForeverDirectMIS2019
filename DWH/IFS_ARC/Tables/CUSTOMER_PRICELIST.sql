CREATE TABLE [IFS_ARC].[CUSTOMER_PRICELIST] (
    ...
    CONSTRAINT [PK_CUSTOMER_PRICELIST] PRIMARY KEY CLUSTERED ([COMPANY] ASC, [CURRENCY_CODE] ASC, [CUSTOMER_NO] ASC, [Eff_Date] ASC, [SALES_PRICE_GROUP_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
