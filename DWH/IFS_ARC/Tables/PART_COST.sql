CREATE TABLE [IFS_ARC].[PART_COST] (
    ...
    CONSTRAINT [PK_PART_COST] PRIMARY KEY CLUSTERED ([PART_NO] ASC, [CONTRACT] ASC, [COST_SET] ASC, [ALTERNATIVE_NO] ASC, [ROUTING_ALTERNATIVE_NO] ASC, [Eff_Date] ASC) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
