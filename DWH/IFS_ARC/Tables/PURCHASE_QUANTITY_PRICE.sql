CREATE TABLE [IFS_ARC].[PURCHASE_QUANTITY_PRICE] (
    ...
    CONSTRAINT [PK_PURCHASE_QUANTITY_PRICE] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [Eff_Date] ASC, [LINE_NO] ASC, [PART_NO] ASC, [VENDOR_NO] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_IFS_ARC]
) ON [DWH_IFS_ARC];
