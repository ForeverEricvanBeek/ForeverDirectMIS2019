CREATE TABLE [TRANS_ARC].[KIALA_DEPOT_OLD_2] (
    ...
    CONSTRAINT [PK_KIALA_DEPOT_OLD_2] PRIMARY KEY CLUSTERED ([DEPOT_CODE] ASC, [DEPOT_ID] ASC, [DEPOT_NAME] ASC, [DEPOT_STREET] ASC, [DEPOT_HOUSE_NR] ASC, [DEPOT_ADDRESS_LINE_2] ASC, [DEPOT_POSTAL_CODE] ASC, [DEPOT_CITY] ASC, [DEPOT_PROVINCE] ASC, [DEPOT_COUNTRY_CODE] ASC, [DEPOT_INFO] ASC) ON [DWH_TRANS_ARC]
) ON [DWH_TRANS_ARC];
