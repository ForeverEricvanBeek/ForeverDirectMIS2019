CREATE TABLE [TRANS_ARC].[POSTNORD_DEPOT] (
    ...
    CONSTRAINT [PK_POSTNORD_DEPOT_1] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [PN_DEPOT_COUNTRY_CODE] ASC, [PN_DEPOT_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_TRANS_ARC]
) ON [DWH_TRANS_ARC];
