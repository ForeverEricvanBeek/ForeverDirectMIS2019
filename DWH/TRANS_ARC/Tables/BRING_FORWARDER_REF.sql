CREATE TABLE [TRANS_ARC].[BRING_FORWARDER_REF] (
    ...
    CONSTRAINT [PK_BRING_FORWARDER_REF] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [POS_NR] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_TRANS_ARC]
) ON [DWH_TRANS_ARC];
