CREATE TABLE [TRANS_ARC].[XML_FILE_SHIP_CONFIRM] (
    ...
    CONSTRAINT [PK_XML_FILE_SHIP_CONFIRM] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [XML_FILE_SHIP_CONFIRM_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_TRANS_ARC]
) ON [DWH_TRANS_ARC];
