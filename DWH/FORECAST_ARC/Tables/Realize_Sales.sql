CREATE TABLE [FORECAST_ARC].[Realize_Sales] (
    ...
    CONSTRAINT [PK_Realize_Sales] PRIMARY KEY CLUSTERED ([OFFICE_CODE] ASC, [PRODUCTNUM] ASC, [PROCESSYEAR] ASC, [PROCESSMONTH] ASC, [Quantity] ASC, [Eff_Date] ASC) ON [DWH_FORECAST_ARC]
) ON [DWH_FORECAST_ARC];
