CREATE TABLE [WEB_ARC].[FormShipmentCallImages] (
    ...
    CONSTRAINT [PK_web.FormShipmentCallImages] PRIMARY KEY CLUSTERED ([FormShipmentCallImages_ID] ASC, [Eff_Date] ASC) ON [DWH_WEB_ARC]
