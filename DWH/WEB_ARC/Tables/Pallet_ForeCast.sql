CREATE TABLE [WEB_ARC].[Pallet_ForeCast] (
    ...
    CONSTRAINT [PK_Pallet_ForeCast] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [Pallet_ForeCast_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_WEB_ARC]
) ON [DWH_WEB_ARC];
