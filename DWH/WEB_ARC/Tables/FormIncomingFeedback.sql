CREATE TABLE [WEB_ARC].[FormIncomingFeedback] (
    ...
    CONSTRAINT [PK_FormIncomingFeedback] PRIMARY KEY CLUSTERED ([FormIncomingFeedback_ID] ASC, [Eff_Date] ASC) ON [DWH_WEB_ARC]
