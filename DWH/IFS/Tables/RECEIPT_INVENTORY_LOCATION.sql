CREATE TABLE [IFS].[RECEIPT_INVENTORY_LOCATION] (
    ...
    CONSTRAINT [PK_RECEIPT_INVENTORY_LOCATION] PRIMARY KEY CLUSTERED ([ORDER_NO] ASC, [LINE_NO] ASC, [RELEASE_NO] ASC, [RECEIPT_NO] ASC, [CONTRACT] ASC, [PART_NO] ASC, [CONFIGURATION_ID] ASC, [LOCATION_NO] ASC, [LOT_BATCH_NO] ASC, [SERIAL_NO] ASC, [ENG_CHG_LEVEL] ASC, [WAIV_DEV_REJ_NO] ASC, [ACTIVITY_SEQ] ASC, [Eff_Date] ASC)
);
