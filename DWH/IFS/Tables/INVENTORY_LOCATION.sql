CREATE TABLE [IFS].[INVENTORY_LOCATION] (
    ...
    CONSTRAINT [PK_INVENTORY_LOCATION] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [WAREHOUSE] ASC, [BAY_NO] ASC, [ROW_NO] ASC, [TIER_NO] ASC, [BIN_NO] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
