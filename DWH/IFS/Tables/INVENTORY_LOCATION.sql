CREATE TABLE [IFS].[INVENTORY_LOCATION] (
    ...
    CONSTRAINT [PK_INVENTORY_LOCATION] PRIMARY KEY CLUSTERED ([BAY_NO] ASC, [BIN_NO] ASC, [CONTRACT] ASC, [Eff_Date] ASC, [ROW_NO] ASC, [TIER_NO] ASC, [WAREHOUSE] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
