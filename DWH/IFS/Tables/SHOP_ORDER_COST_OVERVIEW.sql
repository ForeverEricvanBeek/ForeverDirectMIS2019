CREATE TABLE [IFS].[SHOP_ORDER_COST_OVERVIEW] (
    ...
    CONSTRAINT [PK_SHOP_ORDER_COST_OVERVIEW] PRIMARY KEY CLUSTERED ([PART_NO] ASC, [CONTRACT] ASC, [ORDER_NO] ASC, [RELEASE_NO] ASC, [SEQUENCE_NO] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
