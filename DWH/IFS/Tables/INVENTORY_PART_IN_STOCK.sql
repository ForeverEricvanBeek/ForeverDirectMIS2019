CREATE TABLE [IFS].[INVENTORY_PART_IN_STOCK] (
    ...
    CONSTRAINT [PK_INVENTORY_PART_IN_STOCK] PRIMARY KEY CLUSTERED ([ACTIVITY_SEQ] ASC, [CONFIGURATION_ID] ASC, [CONTRACT] ASC, [Eff_Date] ASC, [ENG_CHG_LEVEL] ASC, [LOCATION_NO] ASC, [LOT_BATCH_NO] ASC, [PART_NO] ASC, [SERIAL_NO] ASC, [WAIV_DEV_REJ_NO] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
