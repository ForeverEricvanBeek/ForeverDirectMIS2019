CREATE TABLE [IFS].[INVENTORY_PART_IN_STOCK] (
    ...
    CONSTRAINT [PK_INVENTORY_PART_IN_STOCK] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [PART_NO] ASC, [CONFIGURATION_ID] ASC, [LOCATION_NO] ASC, [LOT_BATCH_NO] ASC, [SERIAL_NO] ASC, [ENG_CHG_LEVEL] ASC, [WAIV_DEV_REJ_NO] ASC, [ACTIVITY_SEQ] ASC, [Eff_Date] ASC) WITH (FILLFACTOR = 90) ON [DWH_IFS]
) ON [DWH_IFS];
