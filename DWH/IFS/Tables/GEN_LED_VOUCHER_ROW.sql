CREATE TABLE [IFS].[GEN_LED_VOUCHER_ROW] (
    ...
    CONSTRAINT [PK_GEN_LED_VOUCHER_ROW] PRIMARY KEY CLUSTERED ([ACCOUNTING_YEAR] ASC, [COMPANY] ASC, [VOUCHER_TYPE] ASC, [VOUCHER_NO] ASC, [ROW_NO] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
