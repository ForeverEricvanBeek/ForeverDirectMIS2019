CREATE TABLE [IFS].[INVENTORY_PART_CONFIG] (
    ...
    CONSTRAINT [PK_INVENTORY_PART_CONFIG] PRIMARY KEY CLUSTERED ([PART_NO] ASC, [CONTRACT] ASC, [CONFIGURATION_ID] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
