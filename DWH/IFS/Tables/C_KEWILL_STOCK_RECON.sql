CREATE TABLE [IFS].[C_KEWILL_STOCK_RECON] (
    ...
    CONSTRAINT [PK_C_KEWILL_STOCK_RECON] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [CUST_NO] ASC, [CUSTOMS_STATUS] ASC, [Eff_Date] ASC, [LOT_BATCH_NO] ASC, [OBJVERSION] ASC, [PART_NO] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
