CREATE TABLE [IFS].[C_KEWILL_STOCK_RECON] (
    ...
    CONSTRAINT [PK_C_KEWILL_STOCK_RECON] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [CUST_NO] ASC, [PART_NO] ASC, [CUSTOMS_STATUS] ASC, [LOT_BATCH_NO] ASC, [OBJVERSION] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
