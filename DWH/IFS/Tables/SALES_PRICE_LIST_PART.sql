CREATE TABLE [IFS].[SALES_PRICE_LIST_PART] (
    ...
    CONSTRAINT [PK_SALES_PRICE_LIST_PART] PRIMARY KEY CLUSTERED ([PRICE_LIST_NO] ASC, [CATALOG_NO] ASC, [MIN_QUANTITY] ASC, [VALID_FROM_DATE] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
