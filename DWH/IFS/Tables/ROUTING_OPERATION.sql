CREATE TABLE [IFS].[ROUTING_OPERATION] (
    ...
    CONSTRAINT [PK_ROUTING_OPERATION] PRIMARY KEY CLUSTERED ([PART_NO] ASC, [CONTRACT] ASC, [ROUTING_REVISION] ASC, [ALTERNATIVE_NO] ASC, [BOM_TYPE_DB] ASC, [OPERATION_ID] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
