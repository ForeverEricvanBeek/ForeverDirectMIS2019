CREATE TABLE [IFS].[CUST_PRICE_GROUP_DETAIL] (
    ...
    CONSTRAINT [PK_CUST_PRICE_GROUP_DETAIL2] PRIMARY KEY CLUSTERED ([CUST_PRICE_GROUP_ID] ASC, [SALES_PRICE_GROUP_ID] ASC, [CURRENCY_CODE] ASC, [COMPANY] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
