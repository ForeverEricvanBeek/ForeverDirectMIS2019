CREATE TABLE [IFS].[PART_COST_BUCKET] (
    ...
    [CUMM_QTY_PER_ASSEMBLY]       DECIMAL (18, 8) NULL,
    [SPLIT_QTY_PER_ASSEMBLY]      DECIMAL (18, 8) NULL,
    [COST_QTY_PER_ASSEMBLY]       DECIMAL (18, 8) NULL,
    ...
    CONSTRAINT [PK_PART_COST_BUCKET] PRIMARY KEY CLUSTERED ([PART_NO] ASC, [CONTRACT] ASC, [COST_SET] ASC, [ALTERNATIVE_NO] ASC, [ROUTING_ALTERNATIVE_NO] ASC, [BUCKET_SEQ] ASC, [TOP_LEVEL_PART_NO] ASC, [BUCKET_LEVEL] ASC, [TOP_ALTERNATIVE_NO] ASC, [TOP_ROUTING_NO] ASC, [COST_BUCKET_ID] ASC, [CALCULATION_DATE] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
