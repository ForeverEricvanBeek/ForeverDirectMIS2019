CREATE TABLE [IFS].[C_KFD_CMSCOUNTER_HIST] (
    ...
    CONSTRAINT [PK_C_KFD_CMSCOUNTER_HIST] PRIMARY KEY CLUSTERED ([CONTRACT] ASC, [Eff_Date] ASC, [LOT_BATCH_NO] ASC, [PART_NO] ASC, [PKG_UNIT_ID] ASC, [TRANSACTION_ID] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
