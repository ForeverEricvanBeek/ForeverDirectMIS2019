CREATE TABLE [IFS].[SHOP_ORDER_COST_BUCKET] (
    ...
    CONSTRAINT [PK_SHOP_ORDER_COST_BUCKET] PRIMARY KEY CLUSTERED ([ORDER_NO] ASC, [RELEASE_NO] ASC, [SEQUENCE_NO] ASC, [PART_NO] ASC, [COST_BUCKET_ID] ASC, [BUCKET_LEVEL] ASC, [BUCKET_SEQ] ASC, [TOP_LEVEL_PART_NO] ASC, [OPERATION_NO] ASC, [COMPANY] ASC, [COST_SOURCE_ID] ASC, [Eff_Date] ASC) ON [DWH_IFS]
) ON [DWH_IFS];
