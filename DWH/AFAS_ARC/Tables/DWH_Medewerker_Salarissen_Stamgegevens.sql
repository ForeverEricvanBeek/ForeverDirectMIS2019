CREATE TABLE [AFAS_ARC].[DWH_Medewerker_Salarissen_Stamgegevens] (
    ...
    CONSTRAINT [PK_DWH_Medewerker_Salarissen_Stamgegevens] PRIMARY KEY CLUSTERED ([Medewerker] ASC, [BegindatumSalaris] ASC, [Eff_Date] ASC) ON [DWH_AFAS_ARC]
) ON [DWH_AFAS_ARC];
