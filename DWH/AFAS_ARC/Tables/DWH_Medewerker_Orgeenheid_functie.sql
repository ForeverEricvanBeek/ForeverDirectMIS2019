CREATE TABLE [AFAS_ARC].[DWH_Medewerker_Orgeenheid_functie] (
    ...
    CONSTRAINT [PK_DWH_Medewerker_Orgeenheid_functie] PRIMARY KEY CLUSTERED ([Medewerker] ASC, [Begindatum] ASC, [Eff_Date] ASC) ON [DWH_AFAS_ARC]
) ON [DWH_AFAS_ARC];
