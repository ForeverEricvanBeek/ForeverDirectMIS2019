CREATE TABLE [AFAS_ARC].[DWH_Medewerker_verzuimmelding] (
    ...
    CONSTRAINT [PK_DWH_Medewerker_verzuimmelding] PRIMARY KEY CLUSTERED ([VerzuimmeldingID] ASC, [Eff_Date] ASC) ON [DWH_AFAS_ARC]
) ON [DWH_AFAS_ARC];
