CREATE TABLE [AFAS_ARC].[DWH_Medewerker_journaalpost] (
    ...
    CONSTRAINT [PK_DWH_Medewerker_journaalpost] PRIMARY KEY CLUSTERED ([Medewerker] ASC, [Looncomponent] ASC, [Salarisverwerkingsplan] ASC, [Volgnummer] ASC, [Jaar] ASC, [Periode] ASC, [OrganisatorischeEenheid] ASC, [Eff_Date] ASC) ON [DWH_AFAS_ARC]
) ON [DWH_AFAS_ARC];
