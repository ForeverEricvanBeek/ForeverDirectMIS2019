...
SELECT DISTINCT 
	...
	,CT.CNTR_DESC						AS OLPN_Container_Description
	,concat(LP.LPN_NBR_X_OF_Y,'-',max(LP.LPN_NBR_X_OF_Y) over (partition by LP.TC_ORDER_ID)) as OLPN_X_Y
...
LEFT JOIN	MANH.CNTR_TYPE CT
ON			CT.CNTR_TYPE = LP.CONTAINER_TYPE
AND			CT.CNTR_SIZE = LP.CONTAINER_SIZE
AND			CT.ActInd='Y'
LEFT JOIN	(
			SELECT
			  P1.olpn
...
LEFT JOIN (
			...
			FROM (
				SELECT DISTINCT
				  ...
				  , CASE 
						WHEN COUNT(*) OVER (PARTITION BY MP1.LPN ORDER BY MP1.CREATE_DATE) = 1 THEN NULL
...
SELECT '-1', NULL, NULL, NULL, NULL, NULL, NULL, NULL,NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,NULL, NULL, NULL, NULL, NULL, NULL, NULL