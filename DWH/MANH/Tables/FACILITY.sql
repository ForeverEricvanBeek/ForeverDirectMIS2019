CREATE TABLE [MANH].[FACILITY] (
    ...
    [DWELL_TIME]                    INT             NULL,
    [FULFILLMENT_GROUP]             NVARCHAR (15)   NULL,
    [GENERATE_PERPETUAL_EVENT]      INT             NULL,
    [GENERATE_SEGMENT_EVENT]        INT             NULL,
    [MAINTAIN_BATCH_NBR]            INT             NULL,
    [MAINTAIN_CNTRY_OF_ORGN]        INT             NULL,
    [MAINTAIN_DISPOSITION]          INT             NULL,
    [MAINTAIN_INV_TYPE]             INT             NULL,
    [MAINTAIN_IN_TRANSIT]           INT             NULL,
    [MAINTAIN_ITEM_ATTR_1]          INT             NULL,
    [MAINTAIN_ITEM_ATTR_2]          INT             NULL,
    [MAINTAIN_ITEM_ATTR_3]          INT             NULL,
    [MAINTAIN_ITEM_ATTR_4]          INT             NULL,
    [MAINTAIN_ITEM_ATTR_5]          INT             NULL,
    [MAINTAIN_ON_HAND]              INT             NULL,
    [MAINTAIN_ON_ORDER]             INT             NULL,
    [MAINTAIN_PROD_STAT]            INT             NULL,
    [MAINTAIN_SEGMENT]              INT             NULL,
    [MAINTAIN_SUBLOCATION]          INT             NULL,
    [PENALTY_COST]                  NUMERIC (13, 4) NULL,
    [PENALTY_COST_CURRENCY_CODE]    NVARCHAR (3)    NULL,
    ...
    CONSTRAINT [PK_MANH_FACILITY] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [FACILITY_ID] ASC) ON [DWH_MANH]
) ON [DWH_MANH];
