CREATE TABLE [MANH].[ORDER_LINE_ITEM] (
    ...
    [ADJUSTED_ORDER_QTY]            NUMERIC (13, 4) NULL,
    [ALLOW_REVIVAL_RECEIPT_ALLOC]   NVARCHAR (2)    NULL,
    ...
    [IS_CHASE_CREATED_LINE]         INT             NULL,
    [IS_GIFT]                       INT             NULL,
    ...
    [SEGMENT_NAME]                  NVARCHAR (15)   NULL,
    [WM_RECEIPT_ALLOCATED]          INT             NULL,
    CONSTRAINT [PK_MANH_ORDER_LINE_ITEM] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LINE_ITEM_ID] ASC, [ORDER_ID] ASC) ON [DWH_MANH]
) ON [DWH_MANH];
