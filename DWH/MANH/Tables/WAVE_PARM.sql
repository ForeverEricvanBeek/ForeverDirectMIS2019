CREATE TABLE [MANH].[WAVE_PARM] (
    ...
    CONSTRAINT [PK_MANH_WAVE_PARM] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [WAVE_PARM_ID] ASC) WITH (FILLFACTOR = 90) ON [DWH_MANH]
) ON [DWH_MANH];
...
GO
CREATE NONCLUSTERED INDEX [NI_MANH_WAVE_PARM_WAVENBR_ACTIND]
    ON [MANH].[WAVE_PARM]([WAVE_NBR] ASC, [ActInd] ASC)
    INCLUDE([CREATE_DATE_TIME]);
