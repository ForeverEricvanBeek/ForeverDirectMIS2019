CREATE TABLE [MANH].[ITEM_CBO] (
    ...
    [SIZE_SEQ]                       INT             NULL,
    CONSTRAINT [PK_MANH_ITEM_CBO] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [ITEM_ID] ASC) WITH (FILLFACTOR = 90) ON [DWH_MANH]
) ON [DWH_MANH];
...
GO
CREATE NONCLUSTERED INDEX [NI_MANH_ITEM_CBO_ITEM_NAME]
    ON [MANH].[ITEM_CBO]([ITEM_NAME] ASC, [ActInd] ASC)
    INCLUDE([ITEM_ID]);
