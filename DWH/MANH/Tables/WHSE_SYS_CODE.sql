CREATE TABLE [MANH].[WHSE_SYS_CODE] (
    ...
    CONSTRAINT [PK_MANH_WHSE_SYS_CODE] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [WHSE_SYS_CODE_ID] ASC) WITH (FILLFACTOR = 90) ON [DWH_MANH]
) ON [DWH_MANH];
