CREATE TABLE [MANH].[ORDERS] (
    ...
    [TOTAL_NBR_OF_UNITS]            NUMERIC (15, 4) NULL,
    [TRANS_PLAN_DIRECTION]          NVARCHAR (1)    NULL,
    [UPSMI_COST_CENTER]             NVARCHAR (35)   NULL,
...
GO
CREATE NONCLUSTERED INDEX [NI_MANH_ORDERS_OUTB]
    ON [MANH].[ORDERS]([ActInd] ASC)
    INCLUDE([ORDER_ID], [BILL_FACILITY_ALIAS_ID], [DSG_SHIP_VIA], [ORDER_TYPE], [DWH_CUSTOMER_ID]);


GO
CREATE NONCLUSTERED INDEX [NI_MANH_ORDERS_ORDERID_STATUS_ACT]
    ON [MANH].[ORDERS]([ORDER_ID] ASC, [DO_STATUS] ASC, [ActInd] ASC);
