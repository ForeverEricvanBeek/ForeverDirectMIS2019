CREATE TABLE [MANH].[PROD_TRKG_TRAN] (
    ...
    CONSTRAINT [PK_MANH_PROD_TRKG_TRAN] PRIMARY KEY CLUSTERED ([PROD_TRKG_TRAN_ID] ASC) WITH (DATA_COMPRESSION = PAGE) ON [DWH_MANH]
) ON [DWH_MANH];
...
GO
CREATE NONCLUSTERED INDEX [NI_MANH_PROD_TRKG_TRAN_MENU_OPTN_NAME]
