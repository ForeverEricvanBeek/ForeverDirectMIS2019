CREATE TABLE [MANH].[LPN_OUTBOUND] (
    ...
    CONSTRAINT [PK_MANH_LPN_OUTBOUND] PRIMARY KEY CLUSTERED ([Eff_Date] ASC, [LPN_ID] ASC)
);
...
GO
CREATE NONCLUSTERED INDEX [NI_MANH_LPN_OUTBOUND_TC_LPN_ID]
    ON [MANH].[LPN_OUTBOUND]([TC_LPN_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [NI_MANH_LPN_OUTBOUND_ORDER_ID]
    ON [MANH].[LPN_OUTBOUND]([ORDER_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [NI_MANH_LPN_OUTBOUND]
    ON [MANH].[LPN_OUTBOUND]([LPN_ID] ASC, [ActInd] ASC)
    INCLUDE([ORDER_ID]);
