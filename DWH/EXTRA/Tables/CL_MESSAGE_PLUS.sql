CREATE TABLE [EXTRA].[CL_MESSAGE_PLUS] (
    ...
    CONSTRAINT [PK_CL_MESSAGE_PLUS] PRIMARY KEY CLUSTERED ([MSG_ID] ASC, [Eff_Date] ASC) ON [DWH_EXTRA]
) ON [DWH_EXTRA];
...
GO
CREATE NONCLUSTERED INDEX [NI_CL_MESSAGE_TYPELPNDIVERT]
    ON [EXTRA].[CL_MESSAGE_PLUS]([TYPE] ASC, [LPN] ASC, [DIVERT] ASC, [ActInd] ASC)
    ON [DWH_EXTRA];
