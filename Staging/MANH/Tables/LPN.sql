CREATE TABLE [MANH].[LPN] (
    ...
    [ALL_PAKD_IN_ONE]                INT             NULL,
    [CALCULATED_CUT_OFF_DTTM]        DATETIME2 (7)   NULL,
    [CN22_NBR]                       NVARCHAR (50)   NULL,
    [CONTAINS_DRY_ICE]               NVARCHAR (1)    NULL,
    [DISPOSITION_SOURCE_ID]          INT             NULL,
    [DISPOSITION_TYPE]               NVARCHAR (3)    NULL,
    [DRY_ICE_WT]                     NUMERIC (13, 4) NULL,
    [END_OLPN_DTTM]                  DATETIME2 (7)   NULL,
    [EPI_MANIFEST_ID]                NVARCHAR (100)  NULL,
    [EPI_PACKAGE_ID]                 NVARCHAR (100)  NULL,
    [EPI_PACKAGE_STATUS]             NVARCHAR (15)   NULL,
    [EPI_SHIPMENT_ID]                NVARCHAR (100)  NULL,
    [FAILED_GUARANTEED_DELIVERY]     NVARCHAR (15)   NULL,
    [HAS_NOTES]                      INT             NULL,
    [OVERPACK]                       INT             NULL,
    [PRE_RECEIPT_STATUS]             NVARCHAR (3)    NULL,
    [Q_VALUE]                        NUMERIC (2, 1)  NULL,
    ...
    [RETURN_TRACKING_NBR_2]          NVARCHAR (50)   NULL,
    [SALVAGE_PACK]                   INT             NULL,
    [SALVAGE_PACK_QTY]               NUMERIC (13, 4) NULL,
    [SPECIAL_PERMITS]                NVARCHAR (50)   NULL,
    [VOCOLLECT_ASSIGN_ID]            INT             NULL,
    [XREF_OLPN]                      NVARCHAR (50)   NULL,
    CONSTRAINT [PK_MANH_LPN] PRIMARY KEY CLUSTERED ([LPN_ID] ASC)
);
